...
public class MainActivityFragment extends Fragment {
    private com.example.doodlz.DoodleView doodleView; // handles touch events and draws
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        doodleView = (com.example.doodlz.DoodleView) view.findViewById(R.id.doodleView);
    ...
    private void confirmErase() {
        com.example.doodlz.EraseImageDialogFragment fragment = new com.example.doodlz.EraseImageDialogFragment();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.line_width:
                com.example.doodlz.LineWidthDialogFragment widthDialog =
                        new com.example.doodlz.LineWidthDialogFragment();
    ...
    public com.example.doodlz.DoodleView getDoodleView() {
        return doodleView;
    }
